...
<div class="page-header mb-0">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Asignar Áreas (Reque) a Usuarios</h2>
            </div>
            <div class="col-12">
                <a href="../../index.php">Inicio</a>
                <a href="">Asignar Áreas (Reque)</a>
            </div>
        </div>
    </div>
    </div>
...
<div class="container mt-5 mb-5">
    ...
    <div class="table-responsive mt-3">
        <table id="tablaRequeUsuario" class="styled-table">
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Asignado</th>
...
<script src="usuario_reque.js"></script>
</body>
</html>
<?php
